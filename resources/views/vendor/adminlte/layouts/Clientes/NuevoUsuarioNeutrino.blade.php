                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="text-right">
                                 <a href="{{url('Usuarios')}}" class="btn btn-morado" data-toggle="tooltip" data-placement="top" title="Gestionar Usuarios Actuales De Neutrino"><i class="fa fa-plus-square" aria-hidden="true"></i> Administrar Usuarios </a> 
                              </div>
                              <div>
                                 <br>
								  <form action="{{ url('/Nuevo_Usuario') }}" method="post">
